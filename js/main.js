...
$(document).ready(function () {
    ...
    function handleForm(event) {
        ...
        // Pattern that will bi used for email validation
        // This pattern is JS object that has method test(value-to-be-tested)
        regex = /^\w+@[a-zA-Z_]+[.]?\.[a-zA-Z]{2,3}$/;
        
        // start with empty <div class="container">
        $(".feedback").html("");
        
        // start with empty array for errors
        err = [];
        
        // start with empty object for user input
        dt = {};
